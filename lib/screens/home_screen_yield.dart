...
class YieldHomeScreen extends StatefulWidget {
  const YieldHomeScreen({super.key});
  @override State<YieldHomeScreen> createState() => _YieldHomeScreenState();
}

class _YieldHomeScreenState extends State<YieldHomeScreen> with SingleTickerProviderStateMixin {
